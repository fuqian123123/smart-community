#ifndef OWNER_FEIYONG_ADD_WIDGET_H
#define OWNER_FEIYONG_ADD_WIDGET_H
...
class OwnerFeiYongAddWidget : public BaseHandleWidget
{
    Q_OBJECT
public:
    OwnerFeiYongAddWidget();
    void sendSignal();
    void init();
...
#endif // OWNER_FEIYONG_ADD_WIDGET_H
